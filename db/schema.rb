...
ActiveRecord::Schema.define(version: 2020_02_16_232940) do
  ...
  create_table "buys", force: :cascade do |t|
    ...
    t.decimal "price_sale", precision: 5, scale: 2, default: "0.0"
  ...
  create_table "rents", force: :cascade do |t|
    ...
    t.integer "movie_id", null: false
    t.integer "quantity", null: false
    t.decimal "price_rental", precision: 5, scale: 2, default: "0.0"
    t.datetime "return_date", null: false
    t.datetime "real_return_date"
    t.decimal "penalty", precision: 5, scale: 2, default: "0.0"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
  end
